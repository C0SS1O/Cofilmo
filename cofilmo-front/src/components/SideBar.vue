  ...
  >
    <header class="relative">
      <div class="flex items-center py-2">
        ...
        >
          <span class="text font-semibold" :class="{ hidden: sidebarClosed }"
            >Cofilmo</span
          >
          <span class="text font-medium" :class="{ hidden: sidebarClosed }"
            >Movie Tracker</span
          >
        </section>
      </div>
    ...
    <section
      class="h-[100%-50px] flex flex-col justify-between whitespace-nowrap py-24"
    >
      <div>
        <ul>
          <li
          ...
          >
            <router-link to="/">
              ...
              >
                <i
                  class="bx bx-home-alt min-w-[2.2rem] text-3xl transition"
                ></i>
                <span
                  class="text ml-8 text-xl"
                  :class="{ hidden: sidebarClosed }"
                  >Home</span
                >
              </a>
            </router-link>
